const fr = {
  ...
  greetingHint: "Choisissez une suggestion ci-dessous ou écrivez librement.",
  ...
  suggestionParcoursTitle: "Parcours guidé",
  suggestionParcoursDesc: "Étape par étape pour signaler un contenu",
...
const ar: Record<TranslationKey, string> = {
  ...
  suggestionParcoursTitle: "",
  suggestionParcoursDesc: "",
  topicPresentation: "",
  topicAide: "",
  topicJuridique: "",
  topicPsychologique: "",
